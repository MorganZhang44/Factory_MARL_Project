...
WORKSPACE="${SIM2REAL_WORKSPACE:-${PROJECT_ROOT}/sim2real/ros2/workspace}"
...
if [[ -z "${UNITREE_ROS2_SETUP}" && -f "${PROJECT_ROOT}/sim2real/unitree_ros2/cyclonedds_ws/install/setup.bash" ]]; then
  UNITREE_ROS2_SETUP="${PROJECT_ROOT}/sim2real/unitree_ros2/cyclonedds_ws/install/setup.bash"
fi
