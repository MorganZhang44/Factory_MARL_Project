...
interactive_demo.py
═══════════════════════════════════════════════════════
Interactive demo: control the intruder (red star) with the mouse
while the trained MAPPO agents (blue dots) try to capture it.

Controls:
  Mouse  ── move the intruder
  R      ── reset the episode
  ESC    ── quit

Run:
  python3 marl/research/scripts/interactive_demo.py
═══════════════════════════════════════════════════════
"""
...
DEFAULT_CFG_PATH  = str(RESEARCH_ROOT / "configs" / "mappo_role_intruder_300k.yaml")
DEFAULT_CKPT_PATH = str(RESEARCH_ROOT / "checkpoints" / "v13_final.pt")
