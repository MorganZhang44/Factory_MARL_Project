...
Usage:
    ...
    python marl/research/scripts/train_mappo.py --config marl/research/configs/mappo_config.yaml --device cuda
"""
...
DEFAULT_CONFIG = Path(__file__).resolve().parents[1] / "configs" / "mappo_config.yaml"
